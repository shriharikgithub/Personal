package adapterpattern.assignment.external;

import java.util.List;

import static adapterpattern.assignment.external.ApiUtils.logMicrosoftGetSupportedLanguages;
import static adapterpattern.assignment.external.ApiUtils.logMicrosoftTranslate;
